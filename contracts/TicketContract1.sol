...
contract TicketContract is ERC721URIStorage {
    ...
    function mint_2g(
        ...
        require(_calledpeople[address1][address2]!=true,"2g address already invited by the 1st generation people");
        _calledpeople[address1][address2]=true;
        require(_invitepeople[address1].length<3,"1g address already invited two people");
